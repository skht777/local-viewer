...
pub(crate) fn build_state(
    ...
    // shutdown 系 3 フィールドを先に確保し、BackgroundContext / AppState 双方で共有する
    let shutdown = crate::state::ShutdownFields::fresh();
    ...
    let bg_context = BackgroundContext {
        ...
        shutdown_token: shutdown.token.clone(),
        rebuild_task: Arc::clone(&shutdown.rebuild_task),
    };
